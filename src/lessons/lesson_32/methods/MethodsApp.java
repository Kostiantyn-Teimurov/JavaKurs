...
//        Utils.swap(inArray, 1, 2); // массив примитивов не примет
        ...
        // типоБезопасность
//        int sum = Utils.sumElements("Hello", "World");
        int sum = Utils.sumElements(1, 3.5, 10, 11.5, 1.1);
        System.out.println("sum: " + sum);


//        double sumD = Utils.listSum(stringList); // не подходит
        double sumD = Utils.listSum(doubleList);
        System.out.println("sumD: " + sumD);

        System.out.println("\n===================");
//        Utils.addNumbers(doubleList);
