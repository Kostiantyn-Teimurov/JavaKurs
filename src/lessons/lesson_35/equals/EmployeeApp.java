...
public class EmployeeApp {
    ...
    public static void main(String[] args) {
        ...
        Employee employeeData = new Employee("Петр", "Петров", "01.01.2005");
        ...
        System.out.println("employee.equals(employeeData): " + employee.equals(employeeData)); // true, дату не проверяем на этом этапе
